    ...
    <div className="space-y-6">
      <div className="rounded-[28px] bg-[#092B44] p-6 text-white">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-white/75">
          Profile editing remains read-only until a dedicated client profile update endpoint is confirmed.
        </p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="pt-6">
          <p className="text-sm leading-6 text-slate-600">
            This page is intentionally read-only because a dedicated client profile save endpoint is not clearly confirmed in the current frontend contract. Once the backend exposes supported update behavior, this page can enable editing without affecting existing authentication logic.
          </p>
        </CardContent>
      </Card>
    </div>
